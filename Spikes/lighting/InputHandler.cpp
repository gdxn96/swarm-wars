...
float InputHandler::getLeftThumbByAngle()
{

	//180 * radians / 3.14
	float x,y;
	x = LeftThumbStickDirection.Normalize().x;
	y = LeftThumbStickDirection.Normalize().y;
	return 180 *(atan2(y,x)) /M_PI;
}
float InputHandler::getRightThumbByAngle()
{
	float x,y,angle;
	x = RightThumStickDirection.Normalize().x;
	y = RightThumStickDirection.Normalize().y;
...
float InputHandler::getLeftThumbByRadian()
{
...
float InputHandler::getRightThumbByRadian()
{
	float x,y;
	x = RightThumStickDirection.Normalize().x;
	y = RightThumStickDirection.Normalize().y;
